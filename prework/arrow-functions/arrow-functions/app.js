...
let sum = (val1, val2, val3, val4) => `${val1 + val2 + val3 + val4}`;
...
// this is this instance of Student
// 2. What is "this" when joe.scopeArrow() is invoked?
// this is the exact instance of when the arrow function is run. It doesn't get the right information from the constructor
